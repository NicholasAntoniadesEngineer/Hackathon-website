...
namespace ThePowerRanges.Migrations
{
    ...
    [Migration("20191012222304_Test3")]
    partial class Test3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThePowerRanges.Models.Amounts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ThePowerRanges.Models.ExpenseCollection", b =>
                {
                    ...
                    b.Property<int?>("Amounts_Id");

                    b.HasKey("Id");

                    b.HasIndex("Amounts_Id");
            ...
            modelBuilder.Entity("ThePowerRanges.Models.ExpenseCollection", b =>
                {
                    b.HasOne("ThePowerRanges.Models.Amounts", "Amounts_")
                        .WithMany()
                        .HasForeignKey("Amounts_Id");
                });
